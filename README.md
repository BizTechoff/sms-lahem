...
```sh
npx degit noam-honig/sms-lahem.git my-project
cd my-project
npm i
```
...
# Tutorial:
See [Creating a Fullstack Angular Remult app for non web developer](https://github.com/noam-honig/sms-lahem/wiki/Creating-a-Fullstack-Angular-Remult-app-for-non-web-developer)
